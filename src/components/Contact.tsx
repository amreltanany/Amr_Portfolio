  ...
  return (
    <section id="contact" className="relative px-6 py-24 lg:px-16 lg:py-32">
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(circle at 50% 50%, rgba(154,129,116,0.1), transparent 50%)',
        }}
      />
          ...
          <div className="flex flex-col gap-5 lg:col-span-2">
            ...
            <div className="rounded-2xl glass-card p-5">
              <div className="mb-3 flex items-center gap-3">
                <span className="relative block h-2.5 w-2.5 rounded-full bg-success shadow-[0_0_12px_rgba(154,129,116,0.8)]">
