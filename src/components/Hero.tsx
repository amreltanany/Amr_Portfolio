  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(90deg, rgba(5,2,6,0.95) 0%, rgba(59,59,59,0.182) 40%, rgba(5,2,6,0.4) 100%)',
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(circle at 78% 20%, rgba(154,129,116,0.13), transparent 28%)',
        }}
      />
        ...
        <div className="flex w-full flex-col gap-6 lg:flex-row lg:items-center lg:gap-9">
          <div className="w-full max-w-sm rounded-2xl glass-card p-6 shadow-2xl shadow-black/40">
            <div className="flex items-center gap-3">
              <span className="relative block h-2.5 w-2.5 shrink-0 rounded-full bg-success shadow-[0_0_12px_rgba(154,129,116,0.8)]">
